...
class GossipServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("ackHandler", new GossipDigestAckHandler());
        pipeline.addLast("ack2Handler", new GossipDigestAck2Handler());
    }
